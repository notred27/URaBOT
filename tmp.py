...
def tokenize_function(example):
    return tokenizer(example, return_tensors='pt', padding=True, truncation=True) # FIXME: Arbitrary max_length
...
trainer.save_model("debertaV3Base")  # Specify your desired path
tokenizer.save_pretrained("debertaV3Base")  # Save the tokenizer
